...
import OctahedronGeometry from '../geometry/OctahedronGeometry.js'
import MeshBasicMaterial from '../material/MeshBasicMaterial.js'
class Octahedron extends React.Component{
	...
	render(){
		...
		return <Mesh position={position} rotation={this.props.rotation}>
			<OctahedronGeometry parameters={this.props.geometry_parameters}/>
